...
export default function TailwickBoundleJs() {
      ...
      (function () {
        ...
        function inputSpinComponents() {
          ...
          function recalculateCart() {
            ...
            const cartTex = elm.parentElement.querySelector(
              ".table-total .cart-tax"
            );
            if (cartTex) {
        ...
        function drawerSetting() {
          const allDrawerButtons = document.querySelectorAll(
            "[data-drawer-target]"
          );
        ...
        function initTooltip() {
          ...
          allTooltipButtons.forEach((element) => {
            ...
            if (element.getAttribute("data-tooltip-placement"))
              tippyOptions.placement = element.getAttribute(
                "data-tooltip-placement"
              );
            if (element.getAttribute("data-tooltip-content"))
              tippyOptions.content = element.getAttribute(
              ...
              tabContainer
                ...
                .forEach(function (tabItem) {
                  ...
                  tabItem.addEventListener("click", function () {
                    ...
                    if (tabContents) {
                      var activeTabItem =
                        tabContainer.querySelector("li.active");
                      if (activeTabItem)
                        activeTabItem.classList.remove("active"); // Remove the "active" class from the currently active tab item
