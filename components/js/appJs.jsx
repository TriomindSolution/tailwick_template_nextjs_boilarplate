...
*/
        ...
        if (document.getElementById("header-lang-img")) {
          if (lang == "en") {
            document.getElementById("header-lang-img").src =
              "assets/images/flags/20/us.svg";
          } else if (lang == "sp") {
            document.getElementById("header-lang-img").src =
              "assets/images/flags/20/es.svg";
          } else if (lang == "gr") {
            document.getElementById("header-lang-img").src =
              "assets/images/flags/20/de.svg";
          } else if (lang == "it") {
            document.getElementById("header-lang-img").src =
              "assets/images/flags/20/it.svg";
          } else if (lang == "ru") {
            document.getElementById("header-lang-img").src =
              "assets/images/flags/20/ru.svg";
          } else if (lang == "ch") {
            document.getElementById("header-lang-img").src =
              "assets/images/flags/20/china.svg";
          } else if (lang == "fr") {
            document.getElementById("header-lang-img").src =
              "assets/images/flags/20/fr.svg";
          } else if (lang == "ar") {
            document.getElementById("header-lang-img").src =
              "assets/images/flags/20/ae.svg";
          } else if (lang == "jp") {
            document.getElementById("header-lang-img").src =
              "assets/images/flags/20/jp.svg";
          } else if (lang == "ar") {
            document.getElementById("header-lang-img").src =
              "assets/images/flags/20/ae.svg";
          }
      ...
      function layoutSetting() {
        const dataLayout = document.querySelectorAll(
          'input[name="dataLayout"]'
        );
        ...
        const sidebarSize = document.querySelectorAll(
          'button[name="sidebarSize"]'
        );
        ...
        const sidebarColor = document.querySelectorAll(
          'button[name="sidebarColor"]'
        );
        ...
        const topbarColor = document.querySelectorAll(
          'button[name="topbarColor"]'
        );
        ...
        const customDefaultSwitch = document.getElementById(
          "customDefaultSwitch"
        );
      ...
      function applyScrollbarLogic() {
        if (
          ...
          if (
            ...
            // scrollbarElement = new SimpleBar(
            //   document.getElementById("scrollbar")
            // );

            scrollbarElement = document.getElementById("scrollbar");
            initActiveMenu();
          } else {
            setTimeout(() => {
      ...
      function initFilters() {
        ...
        Array.from(filterMain).forEach(function (event) {
          ...
          const productItems =
            productItemsMain?.querySelectorAll(".product-item");
          if (productItems)
