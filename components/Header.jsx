          ...
          <div className="flex items-center w-full group-data-[layout=horizontal]:mx-auto group-data-[layout=horizontal]:max-w-screen-2xl navbar-header group-data-[layout=horizontal]:ltr:xl:pr-3 group-data-[layout=horizontal]:rtl:xl:pl-3">
            ...
            >
              <i
                ...
                className="w-5 h-5 group-data-[sidebar-size=sm]:hidden"
              />
              <i
                data-lucide="chevrons-right"
                className="hidden w-5 h-5 group-data-[sidebar-size=sm]:block"
              />
            </button>
            ...
            <div className="flex gap-3 ms-auto">
              <div className="relative flex items-center dropdown h-header">
                ...
                <div
                  className="absolute z-50 hidden p-4 ltr:text-left rtl:text-right bg-white rounded-md shadow-md !top-4 dropdown-menu min-w-[10rem] flex flex-col gap-4 dark:bg-zink-600"
              ...
              <div className="relative flex items-center h-header">
                ...
                >
                  <i
                    data-lucide="sun"
                    className="inline-block w-5 h-5 stroke-1 fill-slate-100 group-data-[topbar=dark]:fill-topbar-item-bg-hover-dark group-data-[topbar=brand]:fill-topbar-item-bg-hover-brand"
                  />
                </button>
              </div>
              <div className="relative flex items-center h-header">
              ...
              <div className="relative flex items-center dropdown h-header">
                <button
                  type="button"
                  className="inline-flex justify-center relative items-center p-0 text-topbar-item transition-all w-[37.5px] h-[37.5px] duration-200 ease-linear bg-topbar rounded-md dropdown-toggle btn hover:bg-topbar-item-bg-hover hover:text-topbar-item-hover group-data-[topbar=dark]:bg-topbar-dark group-data-[topbar=dark]:hover:bg-topbar-item-bg-hover-dark group-data-[topbar=dark]:hover:text-topbar-item-hover-dark group-data-[topbar=brand]:bg-topbar-brand group-data-[topbar=brand]:hover:bg-topbar-item-bg-hover-brand group-data-[topbar=brand]:hover:text-topbar-item-hover-brand group-data-[topbar=dark]:dark:bg-zink-700 group-data-[topbar=dark]:dark:hover:bg-zink-600 group-data-[topbar=brand]:text-topbar-item-brand group-data-[topbar=dark]:dark:hover:text-zink-50 group-data-[topbar=dark]:dark:text-zink-200 group-data-[topbar=dark]:text-topbar-item-dark"
                ...
                <div
                  className="absolute z-50 hidden ltr:text-left rtl:text-right bg-white rounded-md shadow-md !top-4 dropdown-menu min-w-[20rem] lg:min-w-[26rem] dark:bg-zink-600"
                ...
                >
                  <div className="p-4">
                    ...
                    <ul
                      className="flex flex-wrap w-full p-1 mb-2 text-sm font-medium text-center rounded-md filter-btns text-slate-500 bg-slate-100 nav-tabs dark:bg-zink-500 dark:text-zink-200"
                    ...
                    >
                      <li className="grow">
                        <a
                          ...
                          data-filter="all"
                          className="inline-block nav-link px-1.5 w-full py-1 text-xs transition-all duration-300 ease-linear rounded-md text-slate-500 border border-transparent [&.active]:bg-white [&.active]:text-custom-500 hover:text-custom-500 active:text-custom-500 dark:text-zink-200 dark:hover:text-custom-500 dark:[&.active]:bg-zink-600 -mb-[1px] active"
                        >
                          View All
                        </a>
                      </li>
                  ...
                  <div data-simplebar="" className="max-h-[350px]">
                    <div className="flex flex-col gap-1" id="notification-list">
                      <a
                        href="#!"
                        className="flex gap-3 p-4 product-item hover:bg-slate-50 dark:hover:bg-zink-500 follower"
                      >
                        ...
                        <div className="grow">
                          ...
                          <p className="mb-0 text-sm text-slate-500 dark:text-zink-300">
                            <i
                              data-lucide="clock"
                        ...
                        <div className="flex items-center self-start gap-2 text-xs text-slate-500 shrink-0 dark:text-zink-300">
                          <div className="w-1.5 h-1.5 bg-custom-500 rounded-full" />
                          4 sec
                        </div>
                      </a>
                      <a
                        href="#!"
                        className="flex gap-3 p-4 product-item hover:bg-slate-50 dark:hover:bg-zink-500 mention"
                      >
                        ...
                        <div className="grow">
                          ...
                          <p className="mb-3 text-sm text-slate-500 dark:text-zink-300">
                            <i
                              data-lucide="clock"
                              className="inline-block w-3.5 h-3.5 mr-1"
                            />
                          ...
                          <div className="p-2 rounded bg-slate-100 text-slate-500 dark:bg-zink-500 dark:text-zink-300">
                            Amazing! Fast, to the point, professional and really
                      ...
                      <a
                        href="#!"
                        className="flex gap-3 p-4 product-item hover:bg-slate-50 dark:hover:bg-zink-500 invite"
                      >
                        <div className="flex items-center justify-center w-10 h-10 bg-red-100 rounded-md shrink-0">
                          <i
                            data-lucide="shopping-bag"
                            className="w-5 h-5 text-red-500 fill-red-200"
                          />
                        </div>
                        <div className="grow">
                          <h6 className="mb-1 font-medium">
              ...
              <div className="relative flex items-center dropdown h-header">
                ...
                <div
                  className="absolute z-50 hidden p-4 ltr:text-left rtl:text-right bg-white rounded-md shadow-md !top-4 dropdown-menu min-w-[14rem] dark:bg-zink-600"
                ...
                >
                  ...
                  <a href="#!" className="flex gap-3 mb-3">
                    <div className="relative inline-block shrink-0">
                      ...
                      <span className="-top-1 ltr:-right-1 rtl:-left-1 absolute w-2.5 h-2.5 bg-green-400 border-2 border-white rounded-full dark:border-zink-600" />
                    </div>
                    <div>
